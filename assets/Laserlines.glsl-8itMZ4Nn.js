import{wP as Le,wQ as Ce,uB as _,vY as m,uA as F,vg as D,ux as a,uu as he,ve as G,wn as Me,gd as ce,cb as h,m3 as de,ez as Re,uF as ue,_ as pe,uI as _e,uJ as ge,uK as fe,uG as me,rf as $,uQ as Pe,w2 as Ae,cI as o,fg as $e,cH as A,r6 as Te,vt as Oe,nZ as ze,r7 as Ie,r8 as qe,jA as be,e as f,uH as x,wa as He,qb as We,nd as j,wE as je,vG as M,cG as T,nM as X,gD as ve,ey as P,ex as b,wR as we,tZ as Ne,cF as Ue,fH as xe,qf as Be,ls as Fe,gE as Ge,vm as Xe,va as Ze,kf as Z,gH as W,y as q,c as ke,tT as Ye,vo as Je,iH as k,iy as Y,wS as Qe,wT as O,wU as Ke,J,pT as et,tV as tt,wV as it,tW as nt,tX as st,tY as rt,wW as at,gL as Q,jy as K,tU as ee,jz as te,wX as lt,wY as ot,wZ as ht,fb as ct,cC as ie,nO as dt,oI as ut,g9 as pt,jG as ne,w_ as _t,w$ as gt}from"./index-boln7qu7.js";import{t as ft,b as mt}from"./LineVisualElement-P5AHYIgB.js";function Ee(t,e){const i=t.fragment;i.include(Le),t.include(Ce),i.uniforms.add(new _("globalAlpha",n=>n.globalAlpha),new m("glowColor",n=>n.glowColor),new _("glowWidth",(n,s)=>n.glowWidth*s.camera.pixelRatio),new _("glowFalloff",n=>n.glowFalloff),new m("innerColor",n=>n.innerColor),new _("innerWidth",(n,s)=>n.innerWidth*s.camera.pixelRatio),new F("depthMap",(n,s)=>{var r;return(r=s.linearDepth)==null?void 0:r.colorTexture}),new D("nearFar",(n,s)=>s.camera.nearFar),new F("frameColor",(n,s)=>s.mainColor)),i.code.add(a`vec4 blendPremultiplied(vec4 source, vec4 dest) {
...
}`)}function ye(t){const e=new he;e.include(Ee,t);const{vertex:i,fragment:n}=e;return i.uniforms.add(new G("modelView",(s,r)=>Me(bt,r.camera.viewMatrix,s.origin)),new G("proj",(s,r)=>r.camera.projectionMatrix),new _("glowWidth",(s,r)=>s.glowWidth*r.camera.pixelRatio),new D("pixelToNDC",(s,r)=>ce(Pt,2/r.camera.fullViewport[2],2/r.camera.fullViewport[3]))),e.attributes.add(h.START,"vec3"),e.attributes.add(h.END,"vec3"),e.attributes.add(h.UP,"vec3"),e.attributes.add(h.EXTRUDE,"vec2"),e.varyings.add("uv","vec2"),e.varyings.add("vViewStart","vec3"),e.varyings.add("vViewEnd","vec3"),e.varyings.add("vViewPlane","vec4"),i.code.add(a`void main() {
...
}`),e}const Pt=de(),bt=Re(),vt=Object.freeze(Object.defineProperty({__proto__:null,build:ye},Symbol.toStringTag,{value:"Module"}));class z extends _e{initializeProgram(e){return new ge(e.rctx,z.shader.get().build(this.configuration),Ve)}initializePipeline(){return fe({blending:me($.ONE,$.ONE_MINUS_SRC_ALPHA),colorWrite:Pe})}}z.shader=new ue(vt,()=>pe(()=>Promise.resolve().then(()=>$t),void 0));const Ve=new Map([[h.START,0],[h.END,1],[h.UP,2],[h.EXTRUDE,3]]);let se=class{constructor(e){this._renderCoordsHelper=e,this._buffers=null,this._origin=o(),this._dirty=!1,this._count=0,this._vao=null}set vertices(e){const i=$e(3*e.length);let n=0;for(const s of e)i[n++]=s[0],i[n++]=s[1],i[n++]=s[2];this.buffers=[i]}set buffers(e){if(this._buffers=e,this._buffers.length>0){const i=this._buffers[0],n=3*Math.floor(i.length/3/2);A(this._origin,i[n],i[n+1],i[n+2])}else A(this._origin,0,0,0);this._dirty=!0}get origin(){return this._origin}draw(e){const i=this._ensureVAO(e);i!=null&&(e.bindVAO(i),e.drawArrays(Te.TRIANGLES,0,this._count))}dispose(){this._vao!=null&&this._vao.dispose()}_ensureVAO(e){return this._buffers==null?null:(this._vao==null&&(this._vao=this._createVAO(e,this._buffers)),this._ensureVertexData(this._vao,this._buffers),this._vao)}_createVAO(e,i){const n=this._createDataBuffer(i);return this._dirty=!1,new Oe(e,Ve,{data:ze(ae)},{data:Ie.createVertex(e,qe.STATIC_DRAW,n)})}_ensureVertexData(e,i){var s;if(!this._dirty)return;const n=this._createDataBuffer(i);(s=e.vertexBuffers.data)==null||s.setData(n),this._dirty=!1}_numberOfRenderVertices(e){return 3*(2*(e.length/3-1))}_createDataBuffer(e){const i=e.reduce((u,c)=>u+this._numberOfRenderVertices(c),0);this._count=i;const n=ae.createBuffer(i),s=this._origin;let r=0,l=0;for(const u of e){for(let c=0;c<u.length;c+=3){const C=A(re,u[c],u[c+1],u[c+2]);c===0?l=this._renderCoordsHelper.getAltitude(C):this._renderCoordsHelper.setAltitude(C,l);const w=this._renderCoordsHelper.worldUpAtPosition(C,wt),d=r+2*c,B=be(re,C,s);if(c<u.length-3){n.up.setVec(d,w),n.up.setVec(d+3,w),n.up.setVec(d+5,w);for(let v=0;v<6;v++)n.start.setVec(d+v,B);n.extrude.setValues(d,0,-1),n.extrude.setValues(d+1,1,-1),n.extrude.setValues(d+2,1,1),n.extrude.setValues(d+3,0,-1),n.extrude.setValues(d+4,1,1),n.extrude.setValues(d+5,0,1)}if(c>0){n.up.setVec(d-2,w),n.up.setVec(d-4,w),n.up.setVec(d-5,w);for(let v=-6;v<0;v++)n.end.setVec(d+v,B)}}r+=this._numberOfRenderVertices(u)}return n.buffer}};const wt=o(),re=o(),ae=Ae().vec3f(h.START).vec3f(h.END).vec3f(h.UP).vec2f(h.EXTRUDE);class N extends He{constructor(){super(...arguments),this.contrastControlEnabled=!1}}f([x()],N.prototype,"contrastControlEnabled",void 0);const U=j(6);function De(t){const e=new he;e.include(je),e.include(Ee,t);const i=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(i.uniforms.add(new _("maxPixelDistance",(n,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(n.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(n.lineVerticalPlaneSegment.origin))),i.code.add(a`float planeDistancePixels(vec4 plane, vec3 pos) {
float dist = dot(plane.xyz, pos) + plane.w;
float width = fwidth(dist);
dist /= min(width, maxPixelDistance);
return abs(dist);
}`),t.spherical){const n=(r,l,u)=>P(r,l.heightManifoldTarget,u.camera.viewMatrix),s=(r,l)=>P(r,[0,0,0],l.camera.viewMatrix);i.uniforms.add(new M("heightManifoldOrigin",(r,l)=>(n(g,r,l),s(E,l),be(E,E,g),T(p,E),p[3]=X(E),p)),new m("globalOrigin",(r,l)=>s(g,l)),new _("cosSphericalAngleThreshold",(r,l)=>1-Math.max(2,ve(l.camera.eye,r.heightManifoldTarget)*l.camera.perRenderPixelRatio)/X(r.heightManifoldTarget))),i.code.add(a`float globeDistancePixels(float posInGlobalOriginLength) {
...
vec4 color = vec4(0, 0, 0, 0);`),t.heightManifoldEnabled){i.uniforms.add(new D("angleCutoff",s=>R(s)),new M("heightPlane",(s,r)=>Se(s.heightManifoldTarget,s.renderCoordsHelper.worldUpAtPosition(s.heightManifoldTarget,g),r.camera.viewMatrix)));const n=t.spherical?a`normalize(globalOrigin - pos)`:a`heightPlane.xyz`;i.code.add(a`
    ...
    `)}return t.pointDistanceEnabled&&(i.uniforms.add(new D("angleCutoff",n=>R(n)),new M("pointDistanceSphere",(n,s)=>xt(n,s))),i.code.add(a`{
float pointDistanceSphereDistance = sphereDistancePixels(pointDistanceSphere, pos);
vec4 pointDistanceSphereColor = laserlineProfile(pointDistanceSphereDistance);
float pointDistanceSphereAlpha = 1.0 - smoothstep(angleCutoff.x, angleCutoff.y, abs(dot(normal, normalize(pos - pointDistanceSphere.xyz))));
color = max(color, pointDistanceSphereColor * pointDistanceSphereAlpha);
}`)),t.lineVerticalPlaneEnabled&&(i.uniforms.add(new D("angleCutoff",n=>R(n)),new M("lineVerticalPlane",(n,s)=>Et(n,s)),new m("lineVerticalStart",(n,s)=>yt(n,s)),new m("lineVerticalEnd",(n,s)=>Vt(n,s))),i.code.add(a`{
...
}`)),t.intersectsLineEnabled&&(i.uniforms.add(new D("angleCutoff",n=>R(n)),new m("intersectsLineStart",(n,s)=>P(g,n.lineStartWorld,s.camera.viewMatrix)),new m("intersectsLineEnd",(n,s)=>P(g,n.lineEndWorld,s.camera.viewMatrix)),new m("intersectsLineDirection",(n,s)=>(b(p,n.intersectsLineSegment.vector),p[3]=0,T(g,we(p,p,s.camera.viewMatrix)))),new _("intersectsLineRadius",n=>n.intersectsLineRadius)),i.code.add(a`{
