...
export default function UserPage() {
  ...
  function handleDelete() {
    deleteUser(id).then(() => (window.location.href = "/"));
  }
        ...
        <div className="name editUser flex">
          <div className="userName w-[50vw]">
            <h2 className="text-white mx-auto text-3xl">
              Hello, <span className="text-pink-400">{editFormData?.name}</span>
            </h2>
          </div>
          ...
          <ul>
            ...
            <li className="w-[300px] pt-2">
              ...
              {editFormData?.image && editFormData.image !== "" ? (
                <img
                  className="object-cover rounded-lg shadow-lg shadow-pink-200/25 hover:shadow-pink-500/25"
